...
module.exports = function() {
    ...
    controller.novo_salva = function(req, res) {
        ...
        var telefone1 = req.body.telefone;
        var cpf1 = req.body.cpf;
        var pessoa = { nome: nome1, email: email1, telefone: telefone1, cpf: cpf1 };
    ...
    controller.atualiza_salva = function(req, res) {
        ...
        contatos[id1] = { nome: nome1, email: email1, telefone: telefone1, cpf: cpf1 };
